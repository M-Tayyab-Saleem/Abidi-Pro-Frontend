...
const VerifyOtp = () => {
  ...
  const { pendingVerification, verificationEmail, loading } = useSelector(state => state.auth);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-white text-2xl font-semibold border-b-2 border-orange-500 w-fit mx-auto">Verify OTP</h2>
